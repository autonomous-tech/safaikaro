...
Build an opportunity queue from report_data and config, scored impressions x position gap x intent:
 ...
 d. ahrefs.competitor_gaps and ahrefs.keyword_candidates with difficulty <= 5 and volume >= 100: a new blog or service page from an existing blog file as template (author box without any certification claim, FAQPage schema matching on-page FAQ, data-price spans, contextual WhatsApp prefill, PostHog snippet + prices.js).
...
{"branch": "...", "pr_url": null, "shipped": [{"type": "blog|page|meta|area|cro|instrumentation|llms", "page": "/path", "reason": "queue item it answers, no numbers", "critic": "passed|passed after fix"}], "dropped": [{"type": "...", "page": "...", "reason": "..."}], "ledger_added": ["..."], "instrumentation_added": ["..."], "no_pr_reason": null}
